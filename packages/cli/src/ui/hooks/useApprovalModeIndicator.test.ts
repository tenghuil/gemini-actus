...
import { Config, ApprovalMode } from '@google/gemini-actus-core';
import type { Config as ActualConfigType } from '@google/gemini-actus-core';
...
vi.mock('@google/gemini-actus-core', async () => {
  const actualServerModule = await vi.importActual('@google/gemini-actus-core');
  return {
    ...actualServerModule,
    Config: vi.fn(),
  };
