...
export interface ConfigParameters {
  ...
  noBrowser?: boolean;
  browserExecutionMode?: 'puppeteer' | 'extension' | 'auto';
...
export class Config {
  ...
  readonly browserExecutionMode: 'puppeteer' | 'extension' | 'auto';
  ...
  constructor(params: ConfigParameters) {
    ...
    this.browserExecutionMode = params.browserExecutionMode ?? 'auto';
