...
/**
 * Decoupled LLM request format - stable across Gemini Actus versions
 */
...
/**
 * Decoupled LLM response format - stable across Gemini Actus versions
 */
...
/**
 * Decoupled tool configuration - stable across Gemini Actus versions
 */
