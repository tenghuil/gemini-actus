...
const AGENT_URL = 'ws://localhost:41243'; // Port for the agent's browser control server
...
function updateIcon(state) {
  // Conceptual icon update
  // chrome.action.setIcon({ path: state === 'on' ? 'icon_on.png' : 'icon_off.png' });
}
